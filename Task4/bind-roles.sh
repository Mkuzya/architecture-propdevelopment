...
# PropDevelopment - Создание RoleBinding и ClusterRoleBinding
...
# Функция для создания RoleBinding
create_role_binding() {
    local name=$1
    local role=$2
    local namespace=$3
...
# Security Audit команда - security-auditor
...
# Дополнительные RoleBinding для namespace-admin в других namespace'ах
echo "=== Создание дополнительных namespace-admin привязок ==="

# Client Services namespace-admin
...
# Finance Services namespace-admin
