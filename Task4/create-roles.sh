...
# Скрипт для создания ролей Kubernetes
# PropDevelopment - Создание ролей для RBAC

set -e

echo "=== Создание ролей Kubernetes для PropDevelopment ==="

# Создание ClusterRole для cluster-admin
...
# Создание ClusterRole для security-auditor
...
# Создание ClusterRole для monitoring
...
# Создание ClusterRole для viewer
...
# Создание namespace-admin ролей для каждого namespace
echo "=== Создание namespace-admin ролей ==="
...
# Создание developer ролей для каждого namespace
